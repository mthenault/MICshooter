...
class Hud():
	...
	def blit(self, ship, level):
		...
		if ship.weapon==1:
			...
			screen.blit(self.single_sprites['sprite_laser.png'],(160, common_pygame.screenheight-220 -self.offset))
			screen.blit(self.inf,(185, common_pygame.screenheight-227 -self.offset))
		else:
			ammo_txt = self.font.render(str(ship.ammo), True, (0,130, 255))
			screen.blit(self.single_sprites['ball1.png'],(160, common_pygame.screenheight-220-self.offset ))
			screen.blit(ammo_txt,(185, common_pygame.screenheight-227 -self.offset))
